...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline const ::tutorial::Person_PhoneNumber& phone() const;
  inline ::tutorial::Person_PhoneNumber* mutable_phone();
  inline ::tutorial::Person_PhoneNumber* release_phone();
  inline void set_allocated_phone(::tutorial::Person_PhoneNumber* phone);
...
inline ::tutorial::Person_PhoneNumber* Person::mutable_phone() {
  set_has_phone();
  if (phone_ == NULL) phone_ = new ::tutorial::Person_PhoneNumber;
