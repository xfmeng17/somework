                                                   ...
                                                   */
{
 ...
 public:
  ...
  const ::tutorial::Person_PhoneNumber& phone() const;
  ::tutorial::Person_PhoneNumber* mutable_phone();
  ::tutorial::Person_PhoneNumber* release_phone();
  void set_allocated_phone(::tutorial::Person_PhoneNumber* phone);
 ...
 private:
  ...
  ::tutorial::Person_PhoneNumber* phone_;
...
inline void Person::set_has_id() { _has_bits_[0] |= 0x00000002u; }
...
inline void Person::set_has_email() { _has_bits_[0] |= 0x00000004u; }
inline void Person::clear_has_email() { _has_bits_[0] &= ~0x00000004u; }
...
inline void Person::set_has_phone() { _has_bits_[0] |= 0x00000008u; }
inline void Person::clear_has_phone() { _has_bits_[0] &= ~0x00000008u; }
inline void Person::clear_phone() {
  if (phone_ != NULL) phone_->::tutorial::Person_PhoneNumber::Clear();
  clear_has_phone();
}
inline const ::tutorial::Person_PhoneNumber& Person::phone() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.phone)
  return phone_ != NULL ? *phone_ : *default_instance_->phone_;
}
inline ::tutorial::Person_PhoneNumber* Person::mutable_phone() {
  set_has_phone();
  if (phone_ == NULL) {
...
inline ::tutorial::Person_PhoneNumber* Person::release_phone() {
...
inline void Person::set_allocated_phone(::tutorial::Person_PhoneNumber* phone) {
  delete phone_;
  phone_ = phone;
  if (phone) {
    set_has_phone();
...
template <>
struct is_proto_enum< ::tutorial::Person_PhoneType>
    : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor*
GetEnumDescriptor< ::tutorial::Person_PhoneType>() {
